                    ...
                    <div class="card p-4">
                        <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" type="text" name="nv_taiKhoan" value="{{ old('nv_taiKhoan') }}" required autofocus placeholder="Tên đăng nhập">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" type="text" name="nv_matKhau" required placeholder="Mật khẩu">
                                @if ($errors->has('nv_taiKhoan'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('nv_taiKhoan') }}</strong>
                                    </span>
