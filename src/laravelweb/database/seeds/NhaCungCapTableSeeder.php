...
class NhaCungCapTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        array_push($list, [
            ...
            'ncc_ten'       => 'Mỹ Hòa',
            'ncc_daiDien'   => 'Mỹ Mỹ',
            'ncc_diaChi'    => 'TP. Mỹ Tho',
            'ncc_dienThoai' => '0909999000',
            'ncc_email'     => 'mymy@gmail.com',
        ...
        array_push($list, [
            ...
            'ncc_ten'       => 'Long Phú',
            'ncc_daiDien'   => 'Mỹ Ú',
            'ncc_diaChi'    => 'TP. Sóc Trăng',
            'ncc_dienThoai' => '0909999022',
            'ncc_email'     => 'myu@gmail.com',
            'ncc_taoMoi'    => $today->format('Y-m-d H:i:s'),
            'ncc_capNhat'   => $today->format('Y-m-d H:i:s'),
            'xx_ma'         => '4'
        ]);
        array_push($list, [
            'ncc_ma'        => '3',
            'ncc_ten'       => 'Vị Thủy',
            'ncc_daiDien'   => 'Xinh Xinh',
            'ncc_diaChi'    => 'TP. Hậu Giang',
            'ncc_dienThoai' => '0909999011',
            'ncc_email'     => 'xinhxinh@gmail.com',
            'ncc_taoMoi'    => $today->format('Y-m-d H:i:s'),
            'ncc_capNhat'   => $today->format('Y-m-d H:i:s'),
            'xx_ma'         => '3'
        ]);
